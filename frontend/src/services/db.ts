...
import type { Note, Snippet, Flashcard, Deck, GitHubUser, EncryptedData, Template } from '../types';
...
class AppDatabase extends Dexie {
  ...
  templates!: Table<Template, number>; // New table for templates
  ...
  constructor() {
    ...
    this.version(4).stores({  
      ...
      decks: '++id, name',
      templates: '++id, title', // Added templates table definition
      settings: 'key',
    });
  }
