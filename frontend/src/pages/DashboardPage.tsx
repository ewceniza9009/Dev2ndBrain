          ...
          <div className="bg-gray-100 dark:bg-gray-800 p-6 rounded-lg shadow-md">
            ...
            <div className="text-center">
              ...
              <button
                ...
                className="w-full px-4 py-3 font-semibold text-white bg-teal-600 rounded-lg hover:bg-teal-700 disabled:bg-gray-600 shadow-md transition-all duration-200"
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-gray-100 dark:bg-gray-800 p-6 rounded-lg shadow-md">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <button onClick={handleCreateNote} className="flex flex-col items-center justify-center p-4 bg-gray-200 dark:bg-gray-700 rounded-lg text-center hover:bg-gray-300 dark:hover:bg-gray-600 shadow-md hover:shadow-lg transition-all duration-200">
              ...
              <button onClick={() => navigate('/snippets')} className="flex flex-col items-center justify-center p-4 bg-gray-200 dark:bg-gray-700 rounded-lg text-center hover:bg-gray-300 dark:hover:bg-gray-600 shadow-md hover:shadow-lg transition-all duration-200">
                <CodeBracketSquareIcon className="h-6 w-6 text-gray-800 dark:text-white" />
                <span className="mt-2 font-semibold text-gray-900 dark:text-white">New Snippet</span>
              </button>
              <button onClick={() => navigate('/flashcards')} className="flex flex-col items-center justify-center p-4 bg-gray-200 dark:bg-gray-700 rounded-lg text-center hover:bg-gray-300 dark:hover:bg-gray-600 shadow-md hover:shadow-lg transition-all duration-200">
                <RectangleStackIcon className="h-6 w-6 text-gray-800 dark:text-white" />
