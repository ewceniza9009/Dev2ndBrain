...
const CommandPalette: React.FC = () => {
  ...
  const coreCommands: Command[] = useMemo(() => [
    // VITAL FIX: Set activeTab to null for all navigation commands
  ...
  ], [navigate, handleCreateNote, handleCreateSnippet, handleCreateDeck, toggleCommandPalette, setActiveTab]);
