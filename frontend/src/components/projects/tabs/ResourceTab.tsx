...
    const { updateProject } = useProjectStore();
    ...
    const snippets = useLiveQuery(() => db.snippets.filter(s => !s.isDeleted).toArray(), []) || [];
...
                                        </button>
                                    ) : (
                                        <a href={resource.link} target="_blank" rel="noopener noreferrer" className="text-teal-600 dark:text-teal-400 hover:underline">
                                            {getResourceTitle(resource)}
                                        </a>
                                    )}
                                </td>
