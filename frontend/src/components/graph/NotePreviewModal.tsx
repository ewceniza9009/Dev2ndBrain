...
import { XMarkIcon, FolderOpenIcon } from '@heroicons/react/20/solid';
...
          <button onClick={handleOpenInTab} className="flex items-center space-x-2 px-4 py-2 bg-teal-600 text-white rounded-lg hover:bg-teal-700 shadow-md hover:shadow-lg transition-all duration-200">
            <FolderOpenIcon className="h-5 w-5" />
            <span>Open in Tab</span>
          </button>
          <button onClick={handleNavigateToNote} className="flex items-center space-x-1 px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 shadow-md hover:shadow-lg transition-all duration-200">
