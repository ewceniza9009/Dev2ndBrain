...
          </div>
        </div>
        <div className="min-h-[60vh] border border-gray-300 dark:border-gray-600 rounded-md overflow-hidden">
          <Editor
...
          </button>
          {isRunnableWeb && (
            <button onClick={handlePopout} className="flex items-center space-x-1 bg-cyan-600 text-white rounded-lg px-4 py-2 text-sm hover:bg-cyan-700 shadow-md hover:shadow-lg transition-all duration-200">
