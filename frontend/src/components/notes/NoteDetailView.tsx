// File: src/components/notes/NoteDetailView.tsx
...
const NoteDetailView: React.FC<NoteDetailViewProps> = ({ note, isFromGraph, isTabbedView = false }) => {
