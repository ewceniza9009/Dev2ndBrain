...
const TabContentRenderer: React.FC<TabContentRendererProps> = ({ tabId }) => {
  const { tabs, closeTab, updateTabState } = useAppStore();
  ...
  switch (tab.type) {
    ...
    case 'graph-filter': {
        ...
        const handleAnnotationChange = (newState: AnnotationState) => {
            updateTabState(tab.id, { annotationLayerState: newState });
        };
        ...
        return (
            <div className="h-full w-full relative">
                ...
                <AnnotationLayer
                    initialState={tab.annotationLayerState}
                    onStateChange={handleAnnotationChange}
                />
            </div>
        );
    }
